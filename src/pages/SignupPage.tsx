      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-full bg-white border-2 border-gray-200 text-gray-700 font-medium py-4 px-6 rounded-2xl mb-6 hover:border-gray-300 hover:shadow-md transition-all duration-200 flex items-center justify-center gap-3"
          >
